    ...
    <section className={styles.contactsSection} id="contacts">
      ...
      <div className={styles.content}>
        ...
        <div className={styles.messageBox}>
          ...
          <a href="https://linkedin.com/in/rahul-kumar-20r123" target="_blank" rel="noreferrer" className={styles.contactItem}>
            {/* LinkedIn Icon */}
          ...
          <a href="mailto:rahul9199140817@gmail.com" className={styles.contactItem}>
            {/* Email Icon */}
